  ...
  var e,
    ...
    v = {
      188: (e, t, r) => {
        ...
        i.push([
          e.id,
          '*{margin:0;padding:0;box-sizing:border-box}body{font:bold 20px "Courier"}#main{width:360px;height:420px;background-color:#b7d4a8;margin:100px auto;border:10px solid #000;border-radius:40px;display:flex;flex-flow:column;align-items:center;justify-content:space-around}',
          "",
        ]);
        const c = i;
      },
